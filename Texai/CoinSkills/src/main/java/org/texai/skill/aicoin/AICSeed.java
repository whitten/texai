 ...
 */
@ThreadSafe
public final class AICSeed extends AbstractSkill {

  // the logger
  private static final Logger LOGGER = Logger.getLogger(AICSeed.class);
  ...
  public void receiveMessage(Message receivedMessage) {
    ...
    switch (operation) {
       ...
       * Initialize Task
       *
       * This task message is sent from the container-local parent AICNetworkSeedAgent.AICNetworkSeedRole. It is expected to be the first task message
       ...
       *
       * This task message is sent from the network-singleton, parent AICNetworkSeedAgent.AICNetworkSeedRole. It indicates that the
       ...
       *
       * This task message is sent from the network-singleton parent AICNetworkSeedAgent.AICNetworkSeedRole.
       *
