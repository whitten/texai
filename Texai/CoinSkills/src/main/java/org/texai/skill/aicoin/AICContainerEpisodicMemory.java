/*
 * AICContainerEpisodicMemory.java
 *
 ...
 */
@ThreadSafe
public class AICContainerEpisodicMemory extends AbstractSkill {

  // the logger
  private static final Logger LOGGER = Logger.getLogger(AICContainerEpisodicMemory.class);

  /** Constructs a new ContainerEpisodicMemory instance. */
  public AICContainerEpisodicMemory() {
  }
  ...
  public void receiveMessage(final Message receivedMessage) {
    ...
    switch (operation) {
       ...
       * Initialize Task
       *
       * This task message is sent from the container-local parent AICNetworkEpisodicMemoryAgent.AICNetworkEpisodicMemoryRole. It is expected to be the first task message
       ...
       *
       * This task message is sent from the network-singleton, parent AICNetworkEpisodicMemoryAgent.AICNetworkEpisodicMemoryRole. It indicates that the
       ...
       *
       * This task message is sent from the network-singleton parent AICNetworkEpisodicMemoryAgent.AICNetworkEpisodicMemoryRole.
       *
