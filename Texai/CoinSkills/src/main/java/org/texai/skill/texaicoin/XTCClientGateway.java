 ...
 */
@ThreadSafe
public final class XTCClientGateway extends AbstractSkill {

  // the logger
  private static final Logger LOGGER = Logger.getLogger(XTCClientGateway.class);

  /**
   * Constructs a new XTCClientGateway instance.
   */
  public XTCClientGateway() {
  }
