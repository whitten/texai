 ...
 */
public class XAITestNet3Params extends NetworkParameters {
  ...
  private static XAITestNet3Params instance;

  public static synchronized XAITestNet3Params get() {
    if (instance == null) {
      instance = new XAITestNet3Params();
    }
    return instance;
  }
