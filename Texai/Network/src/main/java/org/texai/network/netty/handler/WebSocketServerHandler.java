 ...
 *
 * Description: Provides a web socket server handler.
 *
...
/**
 * Provides a web socket server handler. Each web socket connection has its own handler instance because the handshaker is not shared.
 *
 * @author reed
 */
@NotThreadSafe
public class WebSocketServerHandler extends SimpleChannelUpstreamHandler {
   ...
   */
  public WebSocketServerHandler(final HTTPRequestHandler httpRequestHandler) {
...
//    final String webSocketURL = "wss://" + httpRequest.getHeader(HttpHeaders.Names.HOST) + WEBSOCKET_PATH;
    final String webSocketURL = "ws://" + httpRequest.getHeader(HttpHeaders.Names.HOST) + WEBSOCKET_PATH;
