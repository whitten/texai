#!/bin/sh
# ****************************************************************************
# * run TexaiMain - the node runtime with remote debugging
...
java -ea -agentlib:jdwp=transport=dt_socket,server=y,address=10000 -Dlog4j.configuration=file://$PWD/log4j.properties -classpath $CLASSPATH org.texai.main.TexaiMain $1 $2 $3 $4 $5 $6 $7
