...
#sudo docker run --name Alice --link Mint:Mint -t -i -p 127.0.1.1:15048:5048 -v /home/reed/docker/Alice:/aicoin -v /etc/localtime:/etc/localtime:ro aicoin-alice bash 'cd Main-1.0 && ./run-alice-demo.sh'
