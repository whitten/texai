...
public class NetworkDeploymentTest {
  ...
  public void testCheckForDeployment() {
    ...
    assertTrue(Message.areMessageStringsEqualIgnoringDate(
            ...
            "[deployFile_Task Test.NetworkDeploymentAgent.NetworkDeploymentRole:NetworkDeployment --> Test.ContainerDeploymentAgent.ContainerDeploymentRole:ContainerDeployment 2015-01-26T23:26:14.774-06:00\n"
            ...
            + ",\n"
            + "  deployFile_Task_zippedBytes=byte[](length=15153),\n"
            + "  deployFile_Task_chunkNumber=30,\n"
