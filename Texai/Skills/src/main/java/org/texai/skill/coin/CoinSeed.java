 ...
 *
 * Description: Coordinates the bittorrent seeding of large blockchain files when required by new full nodes joining
 * the network.
 *
...
public class CoinSeed extends AbstractSkill {
  /**
   * the logger
   */
  private static final Logger LOGGER = Logger.getLogger(CoinSeed.class);
