 ...
 *
 * Description: The secondary audit agents perform random checks that duplicate the intent of the primary audit agent and in
 * certain cases offload audit tasks for parallelization.
 *
...
public class SecondaryAudit extends AbstractSkill {
  /**
   * the logger
   */
  private static final Logger LOGGER = Logger.getLogger(SecondaryAudit.class);
