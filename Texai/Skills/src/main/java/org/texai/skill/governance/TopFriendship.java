 ...
 */
@ThreadSafe
public final class TopFriendship extends AbstractSkill {

  /**
   * the logger
   */
  private static final Logger LOGGER = Logger.getLogger(TopFriendship.class);

  /**
   * Constructs a new TopFriendship instance.
   */
  public TopFriendship() {
  }
