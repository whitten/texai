 ...
 *
 * Description: Replicates the canonical blockchain for a cyrptocurreny as new blocks are created by the nomadic mint agent.
 *
...
public class BlockchainArchive extends AbstractSkill {
  /**
   * the logger
   */
  private static final Logger LOGGER = Logger.getLogger(BlockchainArchive.class);
