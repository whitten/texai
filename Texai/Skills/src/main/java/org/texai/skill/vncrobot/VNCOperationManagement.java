/*
 * VNCOperationManagement.java
 *
 * Created on Mar 14, 2012, 12:07:29 PM
 *
 * Description: Provides top-level management behavior for VNC (remote UI) operations.
 *
...
/** Provides top-level management behavior for VNC (remote UI) operations.
 *
 * @author reed
 */
@NotThreadSafe
public class VNCOperationManagement extends AbstractSkill {

  /** the log4j logger */
  private static final Logger LOGGER = Logger.getLogger(VNCOperationManagement.class);

  /** Constructs a new VNCOperationManagement instance. */
  public VNCOperationManagement() {
  }
