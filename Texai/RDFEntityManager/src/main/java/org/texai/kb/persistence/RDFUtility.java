...
public final class RDFUtility {
   ...
   */
  public static class StatementComparator implements Comparator<Statement>, Serializable {
   ...
   */
  public static class TurtleStatementComparator implements Comparator<Statement>, Serializable {
  ...
  /**
   * Formats an RDF statement as Turtle, extended from the specification to support context. See http://www.w3.org/TeamSubmission/turtle/ .
   *
   * @param statement the statement
   *
   * @return the formatted statement in which namespaces are represented by prefixes
  ...
  /**
   * Asserts the defining statements for a new RDF class. This method is useful in the case where a new RDF class is required but no direct
   * instances of the RDF class will ever be instantiated as Java objects.
   *
  ...
  /**
   * Asserts the defining statements for a new RDF individual. This method is useful in the case where a new RDF individual is required but
   * no corresponding Java class has been created.
   *
   * @param repositoryName the repository name
  ...
  /**
   * Returns the lazy loaded object represented by the given proxy and as a side effect loads the object into its instance field. If the
   * given object is not a proxy then it is returned directly. Ordinarily, proxy objects are automatically loaded whenever any of their
   * methods, except toString(), are called. However there may be situations in which they are assigned to another field. Unless they are
   * initialized they will not be persisted.
   *
   * @param proxyObject the given proxy object
   *
   * @return the lazy loaded object represented by the given proxy and as a side effect loads the object into its instance field. If the
   * given object is not a proxy then it is returned directly.
   */
