/*
 * MinCardinalityRestrictionTest.java
 *
 * Created on Jun 30, 2008, 9:19:00 PM
 *
 * Description: .
 *
 ...
 * @author reed
 */
public class MinCardinalityRestrictionTest {
  ...
  /**
   * Test of getMinCardinality method, of class MinCardinalityRestriction.
   */
  @Test
  public void testGetMinCardinality() {
    LOGGER.info("getMinCardinality");
    final URI onProperty = new URIImpl(Constants.CYC_NAMESPACE + "performedBy");
    MinCardinalityRestriction instance = new MinCardinalityRestriction(onProperty, 10);
    long result = instance.getMinCardinality();
    assertEquals(10, result);
  }

  /**
   * Test of hashCode method, of class MinCardinalityRestriction.
   */
  @Test
  ...
  /**
   * Test of equals method, of class MinCardinalityRestriction.
   */
  @Test
  ...
  /**
   * Test of toString method, of class MinCardinalityRestriction.
   */
  @Test
  public void testToString() {
    ...
    assertEquals("[Restriction on cyc:performedBy, minCardinality 10]", result);
  }
